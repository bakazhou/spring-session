...
public class MyApplicationContext implements ApplicationContext {
    public final Map<String, Object> beanNameMap;
    private final Map<Class<?>, Object> beanClazzMap;

    private final Set<Object> beanSet;
            ...
            for (Constructor<?> constructor : constructors) {
                if (isParameterizedConstructor(constructor.getParameterCount())) {
                    ...
                    for (int i = 0; i < parameterTypes.length; i++) {
                        parameters[i] = beanNameMap.get(parameterTypes[i].getSimpleName());
                    }
    ...
    private void injectDependencies(Object bean) {
        ...
        for (java.lang.reflect.Field field : clazz.getDeclaredFields()) {
            ...
            Object dependency = beanNameMap.get(beanName);
            if (dependency != null) {
                try {
